...
f0, g, ρ0 = 1.0e-4, 9.8, 1.0
H1, H2 = 5.0e3, 5.0e3 # 10 km total depth
Δρ = 0.1              # Yields g' = 0.98, typical for the atmosphere
U0 = 30.0

# Geometry
Nx, Ny, Nz = 64, 128, 2
Lx, Ly = 6.0e6, 2*6.0e6 # 6,000 km domain (synoptic scale)

# Jet Parameters
trans = 1.0
WC = 3e6            # 1,500 km wide jet
...
################################################################################
ψ1_bg_1D, U_bg, zone_start_ind, zone_end_ind = Lee1997_bg_jet(U0, WC; σ=500.0e3)
...
q1_prime = 1.0e-6 * randn(Nx, Ny)   
q2_prime = 1.0e-3 * randn(Nx, Ny)   
