...
U0 = 0.2                          # Internal shear forcing 
trans = 1.0
WC = 205e3                        # half-width baroclinic zone
...
W_shelf = 250e3        # Shelfbreak width 
...
W_wind = 500e3   # Total width of the central wind forcing zone 
...
################################################################################
base_name = "WC_init_beta$(beta)_WC$(WC)_trans$(trans)_r$(r)_h0topo$(h0_topo)_Wshelf$(W_shelf)_U0$(U0)_tau0$(τ0)_alpha$(α)"
